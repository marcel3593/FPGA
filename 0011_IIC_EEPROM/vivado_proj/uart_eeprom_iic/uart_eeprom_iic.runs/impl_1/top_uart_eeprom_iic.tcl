...
set rc [catch {
  ...
  catch { write_mem_info -force top_uart_eeprom_iic.mmi }
  write_bitstream -force top_uart_eeprom_iic.bit 
  catch {write_debug_probes -quiet -force top_uart_eeprom_iic}
  catch {file copy -force top_uart_eeprom_iic.ltx debug_nets.ltx}
