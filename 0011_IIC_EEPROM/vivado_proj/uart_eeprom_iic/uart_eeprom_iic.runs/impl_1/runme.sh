...
HD_PWD='D:/FPGA_study/projects/0011_IIC_EEPROM/vivado_proj/uart_eeprom_iic/uart_eeprom_iic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_eeprom_iic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_eeprom_iic.tcl -notrace
