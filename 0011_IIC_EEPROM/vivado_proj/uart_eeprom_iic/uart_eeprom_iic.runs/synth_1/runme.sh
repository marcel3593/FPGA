...
HD_PWD='D:/FPGA_study/projects/0011_IIC_EEPROM/vivado_proj/uart_eeprom_iic/uart_eeprom_iic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_eeprom_iic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_eeprom_iic.tcl
