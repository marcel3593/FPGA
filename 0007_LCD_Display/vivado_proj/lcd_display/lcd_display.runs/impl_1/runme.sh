...
HD_PWD='D:/FPGA_study/projects/0007_LCD_Display/vivado_proj/lcd_display/lcd_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_display.tcl -notrace
