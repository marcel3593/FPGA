...
HD_PWD='D:/FPGA_study/projects/0007_LCD_Display/vivado_proj/lcd_display/lcd_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_display.tcl
