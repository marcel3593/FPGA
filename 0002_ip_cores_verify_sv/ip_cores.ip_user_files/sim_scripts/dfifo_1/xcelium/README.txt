...
#
# Generated by export_simulation on Thu Dec 29 19:28:07 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dfifo_1.sh' script.

./dfifo_1.sh -reset_run
...
./dfifo_1.sh -noclean_files

For more information on the script, please type './dfifo_1.sh -help'.
