...
HD_PWD='D:/FPGA_study/projects/ip_cores/ip_cores.runs/dfifo_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dfifo_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dfifo_1.tcl
