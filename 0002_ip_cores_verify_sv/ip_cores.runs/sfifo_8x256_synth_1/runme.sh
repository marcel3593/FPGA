...
HD_PWD='D:/FPGA_study/projects/ip_cores/ip_cores.runs/sfifo_8x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sfifo_8x256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sfifo_8x256.tcl
